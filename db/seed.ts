    ...
    await client.query(
      ...
      BEGIN;
          ...
          WITH scenario_count AS (
            ...
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 1)), live_scenario_count AS (
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'admin') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'alpha') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'alpha') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'alpha') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'alpha') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'alpha') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'alpha') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'bravo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'bravo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'bravo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'bravo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'bravo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'bravo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'charlie') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'delta') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'echo') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'foxtrot') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'golf') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'hotel') AND position = 'TAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'india') AND position = 'PAP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAP' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'juliet') AND position = 'ARR') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'ARR' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'kilo') AND position = 'DEP') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'DEP' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'lima') AND position = 'TAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'TAC' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 8)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 5)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 2)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'mike') AND position = 'PAC') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'PAC' AND scenario_number = 1)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'november') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 6)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'november') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 10)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'november') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 7)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'november') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 9)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'november') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 4)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
          ...
          WITH scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
            WHERE assessments.user_position_id = (SELECT id FROM user_positions WHERE user_id = (SELECT id FROM users WHERE username = 'november') AND position = 'FIS') AND scenario_id = (SELECT id FROM scenarios WHERE position = 'FIS' AND scenario_number = 3)), live_scenario_count AS (
            SELECT COUNT(assessment_scenarios.scenario_id) AS live_scenario_count FROM assessment_scenarios
            JOIN assessments ON assessments.id = assessment_scenarios.assessment_id
